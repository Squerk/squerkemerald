...
const u8 gText_InfiniteRepelDeactivated[] = _("The mango scent\nfaded away...{PAUSE_UNTIL_PRESS}");
const u8 gText_InfiniteRepelActivated[] = _("You smell like\nmangoes!{PAUSE_UNTIL_PRESS}");
const u8 gText_PortaHealUsed[] = _("Your party has been\nfully healed!{PAUSE_UNTIL_PRESS}");
