...
const u8 gText_InfiniteRepelDeactivated[] = _("The lemon scent faded away…{PAUSE_UNTIL_PRESS}");
const u8 gText_InfiniteRepelActivated[] = _("You smell like lemons!{PAUSE_UNTIL_PRESS}");
const u8 gText_PortaHealUsed[] = _("Your party has been fully healed!{PAUSE_UNTIL_PRESS}");
