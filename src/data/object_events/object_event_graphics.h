...
const u32 gObjectEventPic_Bel[] = INCBIN_U32("graphics/object_events/pics/people/bel.4bpp");
...
const u16 gObjectEventPal_Bel[] = INCBIN_U16("graphics/object_events/palettes/bel.gbapal");
