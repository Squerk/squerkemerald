...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_CLEAR_BODY, ABILITY_WEAK_ARMOR },
    #else
    ...
    [SPECIES_TIMBURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_GURDURR}),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_MINCCINO] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_SKILL_LINK, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_JOLTIK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_GALVANTULA}),
    },
