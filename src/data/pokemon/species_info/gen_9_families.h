...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_NACLI] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_CLEAR_BODY, ABILITY_PURIFYING_SALT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Nacli"),
        .cryId = CRY_NACLI,
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_DAMP },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_KLAWF] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Klawf"),
        .cryId = CRY_KLAWF,
    ...
    [SPECIES_CAPSAKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_GREEN,
