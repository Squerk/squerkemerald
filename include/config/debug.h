...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU               DISABLED_ON_RELEASE // If set to TRUE, enables a debug menu to use in battles by pressing the Select button. Otherwise it's disabled_on_release
